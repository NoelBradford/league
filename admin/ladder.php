...
$params = array('sql_query'=> 'SELECT * FROM ladder','search'=> $search,'multiple_search'=> $multiple_search,'items_per_page'=> 100,'sort'=> $sort,'page'=> $page,'total_items'=> 100,
